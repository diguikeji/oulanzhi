...
<div class="wrap js-check-wrap">
	...
	<form action="<?php echo U('posts/post_add');?>" method="post" class="form-horizontal js-ajax-forms" enctype="multipart/form-data">
			...
			<div class="span9">
				<table class="table table-bordered">
					<tr>
						...
						<td>
							<select name="post_author">
								<option >选择采集人</option>
								<?php if(is_array($user)): foreach($user as $key=>$vo): ?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["user_nicename"]); ?></option><?php endforeach; endif; ?>
							</select>
						</td>
					</tr>
					<tr>
						<th width="80">采集来源</th>
						<td>
							<input type="text" style="width: 400px;" name="post[post_source]" id="source" value="" placeholder="请输入采集来源"/>
					...
					<tr>
						<th width="80">采集标题</th>
						<td>
							<input type="text" style="width: 400px;" name="post[post_title]" id="title" value="" placeholder="请输入采集标题"/>
							<span class="form-required">*</span>
						</td>
					</tr>
				...
				<table class="table table-bordered">
					...
					<tr>
						<td>
							...
							<label class="radio"><input type="radio" name="post[recommended]" value="0">不推荐</label>
						</td>
					</tr>
				</table>
			</div>
        ...
        Wind.use('validate','ajaxForm','artDialog',function() {
            ...
            form.validate({
                ...
                messages : {
                    ...
                    'post[post_source]' : {required : '请输入采集来源'},
