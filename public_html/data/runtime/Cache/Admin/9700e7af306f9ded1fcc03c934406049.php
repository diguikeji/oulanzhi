...
<div class="wrap js-check-wrap">
    ...
    <form action="<?php echo U('activity/add_post');?>" method="post" class="form-horizontal js-ajax-forms" enctype="multipart/form-data">
        ...
        <div class="row-fluid">
            <div class="span9">
                <table class="table table-bordered">
                    <tr>
                        <th width="80">活动名称</th>
                        <td>
                            <input type="text" style="width: 400px;" name="hd_name" id="name" value="" placeholder="请输入活动名称"/>
                            <span class="form-required">*</span>
                        </td>
                    </tr>
                    <tr>
                        <th width="80">活动外链地址</th>
                        <td>
                            <input type="text" style="width: 400px;" name="hd_url" id="url" value="" placeholder="请输入外链地址"/>
                            <span class="form-required">*</span>
                        </td>
                    </tr>
            ...
            <div class="span3">
                <table class="table table-bordered">
                    ...
                    <tr>
                        <td>
                            <div style="text-align: center;">
                                <input type="hidden" name="hd_img_url" id="thumb" value="">
                    ...
                    <tr>
                        <td>
                            <label class="radio"><input type="radio" name="hd_recommend" value="1" checked>推荐</label>
                            <label class="radio"><input type="radio" name="hd_recommend" value="0">不推荐</label>
                        </td>
                    </tr>
                </table>
            </div>
