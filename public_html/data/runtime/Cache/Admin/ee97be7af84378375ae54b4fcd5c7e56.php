...
<div class="wrap js-check-wrap">
    <ul class="nav nav-tabs">
        ...
        <li class="active"><a href="<?php echo U('xingqu/add');?>">添加兴趣</a></li>
    </ul>
    <form action="<?php echo U('xingqu/add_post');?>" method="post" class="form-horizontal js-ajax-forms" enctype="multipart/form-data">
        ...
        <div class="row-fluid">
            <div class="span9">
                <table class="table table-bordered">
                    <tr>
                        ...
                        <td>
                            <select name="xq_fl_id">
                                ...
                                <?php if(is_array($xqfls)): foreach($xqfls as $key=>$vo): ?><option value="<?php echo ($vo["xqfl_id"]); ?>"><?php echo ($vo["xqfl_name"]); ?></option><?php endforeach; endif; ?>
                            </select>
                        </td>
                    </tr>
                    <tr>
                        <th width="80">兴趣名称</th>
                        <td>
                            <input type="text" style="width: 400px;" name="xq_name" id="name" value="" placeholder="请输入兴趣名称"/>
                    ...
                    <th>兴趣介绍</th>
                    <td>
                    <textarea name="xq_intro" style="width: 98%; height: 200px;"></textarea>
                    </td>
                    </tr>
                </table>
            </div>
                    ...
                    <tr>
                        <td>
                            <div style="text-align: center;">
                                <input type="hidden" name="xq_img" id="thumb" value="">
    ...
    $(function() {
        ...
        Wind.use('validate','ajaxForm','artDialog',function() {
            ...
            form.validate({
                ...
                //验证未通过提示消息
                messages : {
                    'xq_name' : {required : '兴趣名称不能为空'},
                    'xq_intro' : {required : '兴趣介绍不能为空'},
