...
<div class="middle-box" id="designn">
	...
	<a href="javascript:show()">
		<div class="follow-box" style="display: -webkit-box;display: -ms-flexbox;display: -webkit-flex;display: flex;-webkit-box-pack: center;-ms-flex-pack: center;-webkit-justify-content: center;justify-content: center;-webkit-box-align: center;-ms-flex-align: center;-webkit-align-items: center;align-items: center;border: 1px solid gainsboro">
		...
		<div id="login" style="z-index: 9999">
			...
			<div class="title"><form><input class="title-2" type="name" name="username" placeholder="标题" style=" border-bottom: 1px solid dimgrey"></form></div>
			...
			<button
					style="border: none;width: 6rem; height: 3rem; background-color:#FF455F;color: white;font-size: 1.6rem;
                           ...
                           border-top-right-radius: 5px;">确定</button>
		</div>
		<div id="over"></div>
	</a>
