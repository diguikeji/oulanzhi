...
<div class="title-detail">
    <a href="<?php echo U('User/center/tag');?>">所有标签</a>&nbsp; <font  class="address-lable" style="color: #777777"> » <?php echo ($tagname); ?></font>
...
<script  type="text/javascript">
    ...
    $.ajax({
        ...
        url: "/index.php?g=User&m=center&a=tagDetailView&p="+page,
