...
<body>
	...
	<div class="version"><?php echo (THINKCMF_VERSION); ?></div>
		...
		<section class="section">
			...
			<form id="js-install-form" action="/index.php?g=install&a=step4" method="post">
				...
				<div class="bottom text-center">
					<a href="/index.php?g=install&a=step2" class="btn btn-primary">上一步</a>
		...
		<script>
			function TestDbPwd() {
				...
				var url = "/index.php?g=install&a=testdbpwd";
				$.ajax({
					type : "POST",
					url : url,
					data : data,
