...
<div  class="hongse">
    ...
    <a href="<?php echo U('Portal/user/hisInterest',array('id'=>$user[0][id]));?>">
        <div class="hongse_1">
            <div class="hongse_1_2" style="color: white">兴趣点</div>
    ...
    <a href="<?php echo U('Portal/user/hisUser',array('id'=>$user[0][id]));?>">
        <div class="hongse_2"></div>
        <div class="hongse_1">

            <div class="hongse_1_2">用户</div>
        </div></a>
    <a href="<?php echo U('Portal/user/hisDraw',array('id'=>$user[0][id]));?>">
        <div class="hongse_2"></div>
        <div class="hongse_1">
...
<!--中间部分-->
<div class="middle-box" id="xq-box">
...
//关注按钮状态
    ...
    $.ajax({
                ...
                url: "/index.php?g=portal&m=user&a=interestDetailFollow&p="+page,
                ...
                success: function (data) {
                    ...
                    for (var i = 0; i < data.length; i++) {
                        ...
                        if(data[i].pidlist!==null){
                            ...
                            html=html+
                                    '<a href="index.php?g=Portal&m=InterestDetail&a=interest&xid='+xid+'">'+
                                    '<div class="follow-box" >'+
                                    '<img src="index.php?g=&m=Index&a=imgCollect&id='+postIdList[0]+'">'+
                                    '<div class="box-title ">'+
                                    '<div class="with-line-left"></div>'+ data[i].xq_name+
                            ...
                            html=html+
                                    ...
                                    '</div>'+
                                    '<a href=""><button class="following">取消画板</button></a>'+
                                    '</div>'+
                                    '</a>'
